...
class DrawerView extends React.PureComponent {
  constructor(...args) {
    ...
    _defineProperty(this, "changeListener", undefined);
  ...
  componentDidMount() {
    ...
    this.changeListener = _reactNative.Dimensions.addEventListener('change', this.updateWidth);
  }
  ...
  componentWillUnmount() {
    var _this$changeListener;

    (_this$changeListener = this.changeListener) === null || _this$changeListener === void 0 ? void 0 : _this$changeListener.remove();
  }
